...
export const ASSETS = {
  ...
  // Lighter, faster-to-decode variant (Cloudinary transform) used for the
  // in-memory scrub so seeking stays buttery smooth.
  flightVideoScrub:
    'https://res.cloudinary.com/dn5jjkar4/video/upload/w_1280,q_auto:eco/v1784425068/Sky_Globe_vid_rdo8u4.mp4',
